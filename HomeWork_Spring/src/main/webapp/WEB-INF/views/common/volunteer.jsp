	...
	<Br><Br>
		<ul id="volunteer">
			<li class="domestic" >
				...
				<button id="domestic"class="btn btn-lg" aria-expanded="false" data-bs-toggle="dropdown" style="color:#373A40;background: #EEEEEE; border:3px solid rgba(0, 0, 0, 0.1);" ><b>국내봉사</b></button>
			...
			<li class="board">
				...
				<ul class="dropdown-menu" aria-labelledby="board" style="width:13%; background: rgb(45,45,52); color:white;">
					<li><a class="dropdown-item" style="color:white;" href="${contextPath}/domestic.bo">국내게시판</a></li>
		   			<li><a class="dropdown-item" style="color:white;" href="${contextPath}/global.bo">해외게시판</a></li>
		    		<li><a class="dropdown-item" style="color:white;" href="${contextPath}/review.bo">후기게시판</a></li>
		    	</ul>
			</li>
		</ul>
