...
<body>
	            		...
	            		<td>
		            		<div class="col">
		            			<select class="col-4 form-control" name="boardType" style="display:inline; width:100px">
		            				<option value="domestic" value="1">국내</option>
		            				<option value="global" value="2">해외</option>
		            			</select>
	            	...
	            	<tr>
	            		...
	            		<td>
	            			<div class="col m-4 mb-1 mt-2">
	            				<input class="form-check-input " checked  type="radio"  name="gender" id="man" value="M">
					  			<label class="form-check-label " for="man">단체가능</label>
								<input class="form-check-input "  type="radio" name="gender" id="woman" value="F">
					  			<label class="form-check-label" for="woman">불가능</label>
	            			</div>
						</td>
	            	</tr>
	            	<tr>
	...
	<div class="d-flex justify-content-center align-items-center vh-30 row-gap-3" >
		<button type="button" class ="btn btm-lg btn-success m-5" style="width:250px; border-radius:16px;font-size:24px;" onclick="">게시판 작성</button>
	</div>
